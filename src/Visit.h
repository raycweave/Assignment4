...
public:
	...
	Visit(void);						// QUESTION: I made this... Do I delete and just assign to the below constructor?
	// Should be tested
	...
	std::vector<string> getStates() const { return this->state; }
...
private:
	...
	vector<std::string> state; // The ordered list of states at this location.
